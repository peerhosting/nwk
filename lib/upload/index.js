...
app.post('/fileupload', function(req, res) {
    ...
    req.busboy.on('file', function (fieldname, file, filename) {
        ...
        mkdirp(upload, function (err) {
            ...
            // log.info("About to create & seed a torrent for "+filename);

            

       // var addFile = 

       // asyncTODO.push(function(callback){
       //      var fName = filename;
       //      var f = file;
       //      log.info("About to create & seed a torrent for "+fName);

       //      var up = upload + '/' + fName;
       //      var fstream = fs.createWriteStream(up);
       //      f.pipe(fstream);
       //      fstream.on('close', function () {
       //          log.info(up + ' completed writing');
       //          callback(null, fName);
       //      });
       // });
       // log.info('just pushed file  : length -> ' + asyncTODO.length);
    ...
    req.busboy.on('finish', function(){
        // asyncTODO.unshift(makeDir);
        log.info('all finished');
        // async.parallel(asyncTODO, function(err, results){
        //     log.info(results);
        // });
