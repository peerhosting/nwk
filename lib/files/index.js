...
app.get('/updateMySite', function(){
    var site = req.body.siteName;
    console.log('chill, we have our site name');
    socket.emit('updateMySite', {siteName : site});
...
io.sockets.on("connection", function(socket){
    ...
    socket.on('getRoot', function(){
        console.log(rootDir + " root dir");
        socket.emit('root',{root: rootDir});
    })
 ...
 //       });
    ...
    socket.on('deleteFolder', function (folder){
        ...
        console.log(toDelete);
        fs.readdir(toDelete, function(err, data){
            console.log(data);
